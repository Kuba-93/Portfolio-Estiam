...
class PostManagerPDO extends PostManager
{
    ...
    */
    ...
    public function add(Post $post)
    {
        ...
        $req = $this->database->prepare('INSERT INTO post(title, chapo, content, image, categorie, team, niveau, public, tags, creationDate, updateDate, idUser)
                                  VALUES (:title, :chapo, :content, :image, :categorie, :team, :niveau, :public, :tags, NOW(), NOW(), :idUser)');
        ...
        $req->bindValue(':categorie', $post->categorie());
        $req->bindValue(':team', $post->team());
        $req->bindValue(':niveau', $post->niveau());
        $req->bindValue(':public', $post->public());
        $req->bindValue(':tags', $post->tags());
    ...
    */
    ...
    public function update(Post $post)
    {
        ...
        $req->bindValue(':categorie', $post->categorie(), \PDO::PARAM_STR);
        $req->bindValue(':team', $post->team(), \PDO::PARAM_STR);
        $req->bindValue(':niveau', $post->niveau(), \PDO::PARAM_STR);
        $req->bindValue(':public', $post->public(), \PDO::PARAM_STR);
        $req->bindValue(':tags', $post->tags(), \PDO::PARAM_STR);
    ...
    */
    ...
    public function get($idPost)
    {
        ...
        $req = $this->database->prepare('SELECT
                                post.idPost, post.title, post.chapo, post.content, post.image, post.categorie, post.team, post.niveau, post.public, post.tags,
                                post.creationDate AS creationDate,
                                post.updateDate AS updateDate,
                                user.username
                                FROM post
